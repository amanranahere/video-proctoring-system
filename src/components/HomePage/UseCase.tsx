...
export default function UseCase() {
  ...
  return (
    <section id="useCase-section" className="bg-white py-40">
      <h2 className="mx-32 pb-12 lg:text-7xl font-semibold">
        ...
        <ul className="lg:col-span-2 flex flex-col justify-center divide-y-[0.5px] divide-gray-300">
          {useCases.map((item, index) => (
            <li key={index} className="first:pt-0 last:pb-0 select-none">
              ...
              >
                <h3 className="text-xl lg:text-3xl font-bold text-left">
                  {item.title}
                </h3>
              ...
              <AnimatePresence initial={false}>
                {activeIndex === index && (
                  ...
                  >
                    <p className="lg:pb-10 pr-10 lg:pr-16 lg:text-lg leading-tight">
                      {item.description}
                    </p>
